...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/Airy-Qt.rc

win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/Airy-Qt.rc
...
macx:ICON = src/qt/res/icons/Airy.icns
macx:TARGET = "Airy-Qt"
...
win32:LIBS += -lboost_system$$BOOST_LIB_SUFFIX
win32:LIBS += -lboost_filesystem$$BOOST_LIB_SUFFIX
win32:LIBS += -lboost_program_options$$BOOST_LIB_SUFFIX
...
contains(RELEASE, 1) {
    linux {
        ...
        LIBS += -Wl,-Bdynamic
        binfile.files += release/Airy-qt
        binfile.path = /usr/bin
        icon.files += src/qt/res/icons/Airy_64x64.png
        icon.path = /usr/share/Airy-qt/
        shortcut.files += share/linux/Airy-qt.desktop
